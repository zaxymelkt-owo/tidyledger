                  ...
                  <div className="relative">
                    ...
                    {registerOpen && (
                      <>
                        ...
                        <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 w-64 max-w-[calc(100vw-2rem)] menu-card p-2 z-40">
                          <Link
                            to="/register"
          ...
          <div className="ticket-card p-6 sm:p-8">
            <div className="mb-6">
              ...
              <h2 className="font-display text-2xl font-semibold text-ink">
                What can TidyLedger help you do?
              </h2>
              <p className="mt-2 text-sm text-slate max-w-2xl">
                This software is designed to keep every part of a cleaning operation moving smoothly —
                from customer requests to bookkeeping and team coordination.
              </p>
            </div>
